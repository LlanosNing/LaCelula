...
public class CameraMovementIron : MonoBehaviour
{
    public Transform targetPlayer;
    public float minHeight, maxHeight;
    public Transform backgroud, smokeClouds;
    ...
    void LateUpdate()
    {
        ...
        backgroud.position += new Vector3(_amountToMove.x, _amountToMove.y * 1.5f, 0f) * .5f;
        smokeClouds.position += new Vector3(_amountToMove.x, _amountToMove.y * 1.5f, 0f) * .3f;
